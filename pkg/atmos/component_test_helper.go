...
type ComponentTestOption func(*ComponentTestOptions)

// WithFixturesPath is an option for setting the FixturesPath
func WithFixturesPath(fixturesPath string) ComponentTestOption {
	return func(a *ComponentTestOptions) {
		a.FixturesPath = fixturesPath
	}
}

// WithSkipAwsNuke is an option for setting SkipAwsNuke
func WithSkipAwsNuke(skip bool) ComponentTestOption {
	return func(a *ComponentTestOptions) {
		a.SkipAwsNuke = skip
	}
}

// NewComponentTestOptions creates a new ComponentTestOptions with required fields and optional configuration
func NewComponentTestOptions(awsRegion, componentName, stackName string, opts ...ComponentTestOption) ComponentTestOptions {
...
func AwsComponentTestHelper(t *testing.T, opts ComponentTestOptions, callback func(t *testing.T, opts *Options, output string)) {
