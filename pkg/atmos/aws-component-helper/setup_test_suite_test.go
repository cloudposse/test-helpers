...
//		assert.NoError(t, err)
//		assert.Equal(t, existingTS.Suites[0].RandomIdentifier, result.RandomIdentifier)
//		assert.Equal(t, existingTS.Suites[0].TempDir, result.TempDir)
//
//		// Clean up
//		os.Remove(testSuiteFile)
//	})
